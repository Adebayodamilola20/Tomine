...
/**
 * Brand marks are inlined because lucide dropped its brand icon set, and a
 * webfont or CDN sprite would mean an extra network request for three glyphs.
 */
...
const Glyph = ({ name, size }: { name: string; size: number }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
